...
const SingleProductSkeleton = () => {
    ...
    return (
        <div className='py-5 w-full max-h-max flex flex-col gap-10'>

            <div className='flex flex-row items-start justify-center gap-20 py-10 border-b max-h-[250px]'>
                <div className="flex-1 flex flex-col gap-3">
                    <Skeleton className="w-full h-[60px] rounded-[20px] bg-neutral-200" />
                    <Skeleton className="w-full h-[60px] rounded-[20px] bg-neutral-200" />
                </div>
                <div className='flex-1 text-[15px] flex flex-col gap-3'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-5 lg:gap-10 md:h-[600px] overflow-hidden'>
                <div className='w-full md:flex-1 h-[500px] md:h-full flex flex-row gap-5'>
                    ...
                    <Skeleton className="w-[80%] h-[600px] rounded-[20px] bg-neutral-200" />
                </div>

                <div className='w-full md:flex-1 h-full'>
                    <div className='w-full h-full p-2 md:p-5 flex flex-col md:gap-3 lg:gap-8'>
