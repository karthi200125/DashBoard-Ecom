...
export const Testimonials = ({ onLoaded }: any) => {
    ...
    return (
        <div ref={ref} className="sticky_01_panel w-full max-h-max md:rounded-[30px] pt-5 flex items-center justify-center flex-col gap-5 text-white bg-[#222222]">
                    ...
                    {Testimonialsdata.map((t, i) => (
                        <CarouselItem
                            ...
                            <div className="w-full h-[88%] relative rounded-[30px] overflow-hidden flex items-center justify-center group">
                                ...
                                <div className="bg-white text-black md:rounded-full transform scale-0 w-full h-[200%] absolute transition duration-500 ease-out group-hover:scale-100 flex items-center justify-center z-20">
